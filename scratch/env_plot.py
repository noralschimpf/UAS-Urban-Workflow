...
def main():
    ...
    for idx, route in enumerate(routes):
        plt.plot(route[0], route[1], label="Route {}".format(idx), marker="o", linestyle='-', linewidth=3)
    ...
    ax.set_xlim(0-margin, maxAxisX+margin); ax.set_ylim(0-margin, maxAxisY+margin)
